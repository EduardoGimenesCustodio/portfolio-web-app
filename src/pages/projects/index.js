...
const Projects = () => (
    <div className="projects">
        ...
        src="./img/projects/logo_infotrips.svg" alt="Logo InfoTrips" github="https://github.com/EduardoGimenesCustodio/InfoTrips" link="http://infotrips-com-br.umbler.net" color="primary" />
        ...
        src="#" alt="Logo Portfólio" github="#" link="#" color="dark" />
        ...
        src="./img/projects/logo_feelings2.png" alt="Logo Feelings" github="https://github.com/EduardoGimenesCustodio/feelings" link="http://feelingsblog-com-br.umbler.net" color="primary" />
    </div>
);
