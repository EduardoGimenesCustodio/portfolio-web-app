...
const Projects = () => {
  return (
    <div className="projects">
      ...
      <Project
        title="InfoTrips"
        text="Projeto desenvolvido como TCC do curso técnico em Infomática para Internet no IFMS. Consiste em um site informativo sobre viagens internacionais no qual brasileiros podem consultar as regras de outros países para a entrada de estrangeiros em seus territórios."
